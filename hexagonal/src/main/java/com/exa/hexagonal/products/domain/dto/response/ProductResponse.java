package com.exa.hexagonal.products.domain.dto.response;
...
public class ProductResponse {
    ...
    public ProductResponse(String code, String name, String description, String mark, BigDecimal supplierPrice, BigDecimal iva, BigDecimal percentageIncrement, BigDecimal publicPrice, Integer quantity) {
        this.code = code;
        this.name = name;
