...
public class ProductBySellingResponse {
    private String code;
    private String name;
    ...
    public ProductBySellingResponse(){}

    public ProductBySellingResponse(String code, String name, String description, String mark, BigDecimal supplierPrice, BigDecimal iva, BigDecimal percentageIncrement, BigDecimal publicPrice, Integer quantity, Long sellingId) {
        this.code = code;
        this.name = name;
